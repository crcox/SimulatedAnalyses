...
% how many iterations were significant?
% if only 1, then save the error; if not, discard and repeat.
% stop after saving 30 errors: that is, run until we have 30 examples of
% cases where the lasso gets everything on the first iteration.
