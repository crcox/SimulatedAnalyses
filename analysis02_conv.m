...
X1(1:10,1) = X(1:10,1) + 1;   % Adding signals neighbouring to each other
X1(11:20,2) = X(11:20,2) + 1;

X2(1:10,1) = X(1:10,1) + 1;   % Adding signals that far away from each other
X2(11:20,2) = X(11:20,11) + 1;
